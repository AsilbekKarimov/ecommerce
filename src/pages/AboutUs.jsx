...
const AboutUs = () => {
  return (
    <div className=' max-w-[85%] mx-auto  mt-[18%] py-5 relative -top-20'>
      {/* О компании */}
      <div className="flex flex-col w-full text-start">
  <div className="grid h-11 w-[1500px] card rounded-box place-items-center -left-32 bg-[#F4F4F4] relative justify-start "><p className='text-[#33394F9E] relative left-32 '>Главная - О компании</p></div> 
...
{/* место где текст */}
      ...
      <div className="w-[100vh] mx-auto p-4 bg-white rounded-lg  relative top-10 text-base text-[#33394F] flex justify-start -left-44">
...
<div className='mt-16'>
  ...
  1. Нательные комбинезоны 2. Песочники <br />
3. Боди <br />
