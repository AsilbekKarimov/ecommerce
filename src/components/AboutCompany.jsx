...
import PaymentCondition from "./AboutCompany/PaymentCondition";
  ...
  return (
    <div className="py-5  text-center">
      <div className="">
        ...
        <p className="text-[#33394F9E] py-5">
          {" "}
          LalaStore - магазин качественной и модной одежды и товаров для
          новорожденных и малышей до года. <br />
          У нас вы подберете стильный комплект на выписку и базовый гардероб на
          первый год вашего ребенка. <br /> <br />
          Качество товаров на высоте, так как мы работаем только с проверенными
          поставщиками. Все изделия имеют <br /> сертификаты качества. <br />{" "}
          <br />
