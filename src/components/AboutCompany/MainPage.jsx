    ...
    return (
        <div> {/* О компании */}
            <div className="flex flex-col w-full text-start">
                <div className="grid h-11 w-full card place-items-center -left-32 bg-[#F4F4F4] relative justify-start "><p className='text-[#33394F9E] relative left-32 '>Главная - О компании</p></div>
